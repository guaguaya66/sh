...
checkspeedtest() {
	if  [ ! -e './speedtest-cli/speedtest' ]; then
		...
		wget --no-check-certificate -qO speedtest.tgz https://install.speedtest.net/app/cli/ookla-speedtest-1.2.0-$(uname -m)-linux.tgz
...
preinfo() {
	...
	echo "       节点更新: 2022/08/19  | 脚本更新: 2022/10/19"
	echo "——————————————————————————————————————————————————————————"
}
